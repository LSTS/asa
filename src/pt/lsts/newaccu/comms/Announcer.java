...
public class Announcer {
	...
	private Runnable task = new Runnable() {
		@Override
		public void run() {
			boolean announcePosition = newAccu.getInstance().getPrefs()
	...
	public void start() {
		...
		if (announcePosition)
			gpsManager.addListener(locListener);
		boolean announceheading = newAccu.getInstance().getPrefs()
	...
	private void updateLocationOnAnnounce() {
		...
		Location currentLocation = newAccu.getInstance().getGpsManager()
				.getCurrentLocation();
